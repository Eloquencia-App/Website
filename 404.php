...
<div id="404" class="container">
    <div class="row">
        <div class="col-12">
            <h2 class="display-4 text-center">404</h2>
            <p class="lead text-center">La page que vous cherchez n'existe pas. <a href="./">Retour à l'accueil</a></p>
        </div>
    </div>
</div>
<hr class="my-4">
